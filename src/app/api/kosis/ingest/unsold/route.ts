// src/app/api/kosis/ingest/unsold/route.ts
import { NextResponse, type NextRequest } from 'next/server'

type InBody = { start?: string; end?: string; sido?: string; sigungu?: string }
